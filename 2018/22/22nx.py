...
# Part B
# Add edge buffer (guess) and remake
...
# distances = {(0, 0): {'t': 0, 'c': 7, 'n': 7}}
# dists = shortest_paths(G, types, distances)
# # print(dists)
# print(dists[t_loc])
# for loc in [(0, 0), (1, 0),
#             (1,1), (1, 2), (1, 3), (1, 4),
...
# for t1 in (0, 1, 2):
#     for t2 in 'tcn':
#         print(t1, t2, get_dist(t1, t2))

# for loc in [(0,1),(1, 0),(1,1),(1,2),(1,3),(1,4),(2,4)]:
#     print(loc, types[loc], shortest_paths[loc])

# for loc in [(0,0), (0,1), (1,1), (0,2)]:
    # print(loc, types[loc], shortest_paths[loc])

# for loc in [(0,1),(1,1),(1,2),(1,3),(1,4),(2,4)]:
#     print(loc, types[loc])
